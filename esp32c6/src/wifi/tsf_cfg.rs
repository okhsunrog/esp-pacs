...
#[doc = "Field `TSF_ENABLE_AUX` reader - Bit 27 is set together with TSF_ENABLE by tsf_hal_set_tsf_enable, meaning unknown"]
pub type TSF_ENABLE_AUX_R = crate::BitReader;
#[doc = "Field `TSF_ENABLE_AUX` writer - Bit 27 is set together with TSF_ENABLE by tsf_hal_set_tsf_enable, meaning unknown"]
pub type TSF_ENABLE_AUX_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[doc = "Bit 27 - Bit 27 is set together with TSF_ENABLE by tsf_hal_set_tsf_enable, meaning unknown"]
    #[inline(always)]
    pub fn tsf_enable_aux(&self) -> TSF_ENABLE_AUX_R {
        TSF_ENABLE_AUX_R::new(((self.bits >> 27) & 1) != 0)
    }
